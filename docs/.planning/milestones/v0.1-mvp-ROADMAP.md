...
- [x] 001-02-PLAN.md — Migration debt cleanup (Tauri, react-router-dom, TrashPage) + 10 business + 5 pages audit

**Phase 002 Plans:**
- [x] 002-01-PLAN.md — CommandPalette: local search filtering, 150ms debounce, text-only commands, themed empty state
