      ...
      >
        ...
        {image.rating > 0 && (
          <span className="image-card__stamp image-card__stamp--rate" aria-hidden>
            <svg width="12" height="12" viewBox="0 0 18 18" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              <circle cx="9" cy="5" r="3" />
              <circle cx="5.5" cy="8.5" r="3" />
              <circle cx="12.5" cy="8.5" r="3" />
              <circle cx="6.5" cy="13" r="3" />
              <circle cx="11.5" cy="13" r="3" />
              <circle cx="9" cy="9.5" r="1.5" fill="var(--color-bg)" />
            </svg>
            {image.rating > 1 && <span className="image-card__stamp-n">{image.rating}</span>}
          </span>
        )}
